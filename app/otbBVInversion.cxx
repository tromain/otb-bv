...
private:
  void DoInit() override
  {
    ...
    SetParameterDescription( "covariance", 
                             "Input file containing the covariance and the mean expected for reflectances. This file is generated by the ProSailSimulator application. Samples out of the 95% confidence interval will be flagged as invalid (NaN)" );
