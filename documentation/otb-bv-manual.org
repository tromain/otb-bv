...
cat /tmp/MLAI/spot4_*validation > /tmp/MLAI/s4validation
cat /tmp/MLAI/spot4_*validation_gt > /tmp/MLAI/s4validation_gt
#+end_src

#+RESULTS:

#+begin_src gnuplot :file formosat.png 
set terminal pngcairo  transparent enhanced font "arial,10" fontscale 0.9 size 1024, 768 
set title "Formosat-2"
set xlabel "Field LAI"
set ylabel "Estimated LAI"
set grid on
set key left box
plot "/tmp/MLAI/f2validation" using 1:2 t "simus", "/tmp/MLAI/f2validation_gt" using 1:3 lw 3 t "OTB", \
     "/tmp/MLAI/f2validation_gt" using 1:2 lw 3 t "bvnet", x
#+end_src
...
set grid on
set key left box
plot "/tmp/MLAI/l8validation" using 1:2 t "simus", "/tmp/MLAI/l8validation_gt" using 1:3 lw 3 t "OTB", \
     "/tmp/MLAI/l8validation_gt" using 1:2 lw 3 t "bvnet", x
#+end_src
...
set grid on
set key left box
plot "/tmp/MLAI/s4validation" using 1:2 t "simus", "/tmp/MLAI/s4validation_gt" using 1:3 lw 3 t "OTB", \
     "/tmp/MLAI/s4validation_gt" using 1:2 lw 3 t "bvnet", x
#+end_src
